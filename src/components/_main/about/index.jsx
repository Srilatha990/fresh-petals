      ...
      <Box sx={{ my: 8 }}>
        <Grid container spacing={3}>
          ...
          <Grid item md={6} xs={12} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            Creating a World Where Flowers Are a Lifestyle
            </Typography>
            <Typography variant="body1" fontWeight={400} color="text.secondary" mt={2}>
            Craving the beauty of nature without leaving your home? Look no further! At Petal to Vase, we bring the finest, freshest flowers straight to your door. Whether you're decorating your home or celebrating a special occasion, our handpicked blooms ensure that every moment is filled with nature’s elegance. 

Lorem Ipsum has been the industry’s standard placeholder text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
            </Typography>
          </Grid>
        </Grid>
        <Box sx={{ marginTop: 5 }}>
