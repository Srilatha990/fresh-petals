    ...
    >
      <Container maxWidth="xl">
        <Grid container spacing={4}>
          <Grid item md={3}>
            <Stack spacing={3}>
              ...
              Longing for the beauty of fresh flowers at home? Your search ends here! At FreshPetals, we deliver the finest, most vibrant blooms right to your doorstep.
              </Typography>
        ...
        <Typography variant="body1" color="text.primary" textAlign="center">
          © 2024 freshpetals. All rights reserved
        </Typography>
      </Container>
    </Box>
  );
