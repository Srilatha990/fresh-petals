...
const TermsAndConditions = () => {
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      Welcome to freshpetals! These terms and conditions outline the rules and regulations for the use of freshpetals's
      Website.
      </Typography>
      <Typography variant="body1" paragraph>
      By accessing this website we assume you accept these terms and conditions. Do not continue to use freshpetals if you
      ...
      <Typography variant="body1" paragraph>
      Unless otherwise stated, freshpetals and/or its licensors own the intellectual property rights for all material on
        freshpetals. All intellectual property rights are reserved. You may access this from freshpetals for your own personal
      ...
      Certain parts of this website offer the opportunity for users to post and exchange opinions and information in
        certain areas of the website. freshpetals does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of freshpetals, its agents, and/or affiliates.
      ...
      <ul>
      <li>Limit or exclude our or your liability for damage to flowers or floral arrangements during delivery or handling;</li>
        <li>Limit or exclude our or your liability for any misrepresentation or fraud related to the description or quality of flowers;</li>
        <li>Limit any of our or your liabilities in relation to flowers or floral products in a manner that is not permitted under applicable law; or</li>
        <li>Exclude any of our or your liabilities related to flowers that may not be excluded under applicable law.</li>
      </ul>
      <Typography variant="body1" paragraph>
